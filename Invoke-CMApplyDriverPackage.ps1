...
.NOTES
    ...
    4.1.2 - (2021-03-22) - Added support for 1e ACP detection to resolve OSDDownloadContent bug regarding PackageVersion request.
    4.1.3 - (2021-04-19) - Added support for VMware Driver Packages.
#>
...
param(
    ...
    [ValidateNotNullOrEmpty()]
    [ValidateSet("HP", "Hewlett-Packard", "Dell", "Lenovo", "Microsoft", "Fujitsu", "Panasonic", "Viglen", "AZW","VMware")]
    [string]$Manufacturer,
...
Process {
    ...
    function Invoke-CMDownloadContent {
        param(
            ...
            [parameter(Mandatory = $false, ParameterSetName = "NoPath", HelpMessage = "Specify the PackageVersion that will be downloaded.")]
            [Parameter(ParameterSetName = "CustomPath")]
            [ValidateNotNullOrEmpty()]
        ...
        If (Get-Command TSEnv2 -ErrorAction SilentlyContinue) {
            Write-CMLogEntry -Value " - TSEnv2 setting task sequence variable _SMSTSSourceVersion$($PackageId) to: $($PackageVersion)" -Severity 1
    ...
    function Get-ComputerData {
        ...
        switch -Wildcard ($ComputerManufacturer) {
            ...
            "*VMware*" {
                ...
                $ComputerDetails.Model = "Virtual Platform"
                $ComputerDetails.SystemSKU = "Virtual"
            }
        }
